export default function Hero() {
    // Professional avatar image - you can replace this URL with your own image
    const heroImage = "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=500&h=500&fit=crop&crop=face&auto=format&q=80"
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        <h1 className="text-5xl lg:text-7xl font-bold mb-4 tracking-tight">
                            <span className="text-primary block mb-2">MD Mujahidul Islam</span>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                            I’m MD Mujahidul Islam, a passionate MERN Stack Developer with hands-on experience in building responsive, high-performance web applications using MongoDB, Express.js, React, Node.js and Next.js
                        </p>
                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-10">
                            <a className="px-8 py-3 bg-primary hover:bg-primary/90 text-white rounded-full font-medium transition-transform active:scale-95 flex items-center gap-2"
                                href="#projects">
                                View My Work <span className="material-symbols-outlined text-sm">arrow_downward</span>
                            </a>
                            <a className="px-8 py-3 bg-transparent border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full font-medium transition-colors flex items-center gap-2"
                                href="#">
                                <span className="material-symbols-outlined text-sm">download</span> View Resume
                            </a>
                        </div>
                        <div className="flex justify-center lg:justify-start gap-4">
                            <a className="w-10 h-10 rounded-full bg-gray-100 dark:bg-surface-dark border border-gray-200 dark:border-gray-700 flex items-center justify-center hover:text-primary hover:border-primary transition-all"
                        ...
                        <div className="relative w-full max-w-md mx-auto">
                            ...
                            <div className="relative aspect-square rounded-3xl overflow-hidden border-4 border-white dark:border-gray-800 shadow-2xl bg-gradient-to-br from-gray-600 via-green-700 to-gray-700">
                                <img
                                    ...
                                    src={heroImage}
                                    onError={(e) => {
                                        e.target.src = "https://via.placeholder.com/500x500/6366f1/ffffff?text=MD+Mujahidul+Islam"
                                    }}
                                />
